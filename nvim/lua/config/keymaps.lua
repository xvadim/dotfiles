...
km.set("n", "<leader>o", "<cmd>Outline<CR>", { desc = "Toggle Outline" })

-- # Begin of markdown section #
-- https://github.com/linkarzu/dotfiles-latest/blob/867193a6f905efaabd78675d9b9562df14fa60aa/neovim/nvim-lazyvim/lua/config/keymaps.lua
